...
export const PaymentMethods = () => {
  const { methods, addPaymentMethod, removePaymentMethod, setDefaultPayment, upiIds, addUpiId, removeUpiId, setDefaultUpi } = usePaymentStore();
  ...
  const handleDeleteCard = (id: string) => {
    const card = methods.find(c => c.id === id);
    if (card?.isDefault) {
