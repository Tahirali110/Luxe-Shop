...
import { Product, categories, priceRanges, sortOptions } from '@/types/product';
  ...
  const filteredProducts = useMemo(() => {
    ...
    switch (sortBy.value) {
      ...
      case 'rating':
        ...
        break;
      case 'newest':
        // For mongoDB _id, newer items usually have larger hex values if using default ObjectId, 
        // but let's rely on createdAt if available or simplified check
