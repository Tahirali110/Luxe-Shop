...
// Heartbreak animation for cart item removal
export const heartbreakRemove: Variants = {
  ...
  exit: {
    ...
    transition: {
      duration: 0.6,
      ease: [0.36, 0, 0.66, -0.56], // Heavy/sad easing
    },
  },
};
...
export const quantityTransition: Variants = {
